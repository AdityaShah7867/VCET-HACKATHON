...
const faqData1 = [
  {
    ...
    answer: "VCET Hackathon’23 Unleash the unreal will be held online.",
  },
  {
    id: 2,
    question: "Who can participate?",
    answer:
      "Anyone is welcome to participate in this event. While experienced coding and programming is a huge plus, teams will also need people with strong presentation skills and unique ideas.",
  },
  {
    id: 3,
  ...
  },
  {
    ...
    answer:"Problem Statements will be provided from our end. You haveto submit abstracts for all 5 Problem Statements, out of which 1 will be allocated."
  },
  {
    id: 5,
    question: "How much is the entry fee and the last date for registration?",
    answer: "Entry fee is 500/- per team and the last date of registration is September 19, 2021."
  },
  {
    id: 6,
    question: "Which payment methods do you accept?",
    answer: "Payments would occur online (UPI or NEFT)."
  }
...
const faqData2 = [
  ...
  {
    id: 9,
    question: "On which platform will the event be conducted?",
    answer: "Google Meet, YouTube live streaming and Discord."
  },
  {
    id: 10,
    question: "When and where will the final results be announced?",
    answer: "Results will be announced at the end of the Final Pitching round. (Google Meet & YouTube live stream)"
  },
  {
    id: 11,
...
const Faq = () => {
  return (
    <div className="FAQ mb-5 text-light" id="faq">
      <div className="container mt-5">
      <div class="glitch-wrapper">
   <h1 class="glitch" data-text="Frequently Asked Questions">Frequently Asked Questions</h1>
</div>  
